...
<cfif structKeyExists(__fuseboxCircuitCfc_crud4fusebox5_5_controller_app,"save") and isCustomFunction(__fuseboxCircuitCfc_crud4fusebox5_5_controller_app.save)>
<cfset __fuseboxCircuitCfc_crud4fusebox5_5_controller_app.save(myFusebox=myFusebox,event=event) />
<cfelse><cfthrow type="fusebox.undefinedFuseaction" message="undefined Fuseaction" detail="You specified a Fuseaction of save which is not defined in Circuit app.">
</cfif>
