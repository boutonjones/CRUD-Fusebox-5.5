...
<cfif structKeyExists(__fuseboxCircuitCfc_crud4fusebox5_5_model_m_app,"insForm") and isCustomFunction(__fuseboxCircuitCfc_crud4fusebox5_5_model_m_app.insForm)>
<cfset __fuseboxCircuitCfc_crud4fusebox5_5_model_m_app.insForm(myFusebox=myFusebox,event=event) />
<cfelse><cfthrow type="fusebox.undefinedFuseaction" message="undefined Fuseaction" detail="You specified a Fuseaction of insForm which is not defined in Circuit m_app.">
</cfif>
