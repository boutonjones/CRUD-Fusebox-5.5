...
<cfif structKeyExists(__fuseboxCircuitCfc_crud4fusebox5_5_controller_app,"report") and isCustomFunction(__fuseboxCircuitCfc_crud4fusebox5_5_controller_app.report)>
<cfset __fuseboxCircuitCfc_crud4fusebox5_5_controller_app.report(myFusebox=myFusebox,event=event) />
<cfelse><cfthrow type="fusebox.undefinedFuseaction" message="undefined Fuseaction" detail="You specified a Fuseaction of report which is not defined in Circuit app.">
</cfif>
